<?php
namespace Wubs\PlexPhp\Server;

use Wubs\PlexPhp\Exception\Machine as MachineException;
use Wubs\PlexPhp\Exception\Server as ServerException;
use Wubs\PlexPhp\Exception\Server\Library as LibraryException;
use Wubs\PlexPhp\Server;
use Wubs\PlexPhp\Server\Library\ItemAbstract\ItemAbstract;
use Wubs\PlexPhp\Server\Library\SectionAbstract;
...
class Library extends Server
{
	 ...
	 *
	 * @throws \Wubs\PlexPhp\Exception\Server\LibraryException
	 * @uses Library::getSections()
	 * @uses Section::getKey()
	 *
	 * @return Section The request library section.
	 *
