    ...
    implements ItemInterface
{
     ...
     * Plex HTTP API.
     *
     * @uses ItemAbstract::setAllowSync()
     * @uses ItemAbstract::setLibrarySectionId()
     * @uses ItemAbstract::setRatingKey()
     * @uses ItemAbstract::setKey()
     * @uses ItemAbstract::setType()
     * @uses ItemAbstract::setTitle()
     * @uses ItemAbstract::setTitleSort()
     * @uses ItemAbstract::setSummary()
     * @uses ItemAbstract::setIndex()
     * @uses ItemAbstract::setThumb()
     * @uses ItemAbstract::setAddedAt()
     * @uses ItemAbstract::setUpdatedAt()
     * @uses ItemAbstract::setMedia()
     *
     * @return void
     */
     ...
     * item.
     *
     * @uses ItemAbstract::getItemByIndex()
     * @uses SectionAbstract::getPolymorphicItem()
     *
     * @return ItemAbstract A single Plex library item.
     */
     ...
     * @uses SectionAbstract::ENDPOINT_CHILDREN
     * @uses ItemAbstract::getRatingKey()
     *
     ...
     *
     * @uses Library::ENDPOINT_METADATA
     * @uses SectionAbstract::ENDPOINT_ALL_LEAVES
     * @uses ItemAbstract::getRatingKey()
     *
     ...
     *
     * @uses ItemAbstract::$librarySectionId
     *
     ...
     *
     * @uses ItemAbstract::$media
     *
     * @return Item_Media THe media info of the item.
     */
