...
use Wubs\Plex\Exception\Server\Library as LibraryException;
 ...
 * @version 0.0.2
 */
abstract class SectionAbstract extends Library
{
    /**
     ...
     *
     * @uses SectionAbstract::setArt()
     * @uses SectionAbstract::setRefreshing()
     * @uses SectionAbstract::setKey()
     * @uses SectionAbstract::setType()
     * @uses SectionAbstract::setTitle()
     * @uses SectionAbstract::setAgent()
     * @uses SectionAbstract::setScanner()
     * @uses SectionAbstract::setLanguage()
     * @uses SectionAbstract::setUuid()
     * @uses SectionAbstract::setUpdatedAt()
     * @uses SectionAbstract::setCreatedAt()
     *
     * @return void
     */
     ...
     * run.
     *
     * @uses SectionAbstract::ENDPOINT_SEARCH
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_UNWATCHED
     *
     * return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_NEWEST
     *
     * return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_RECENTLY_ADDED
     *
     * return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_ON_DECK
     *
     * return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_RECENTLY_VIEWED
     *
     * return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_COLLECTION
     *
     * @return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_FIRST_CHARACTER
     *
     * @return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_GENRE
     *
     * @return ItemAbstract[] An array of Plex library items.
     */
     ...
     * @uses Library::getItems()
     * @uses SectionAbstract::buildEndpoint()
     * @uses SectionAbstract::ENDPOINT_CATEGORY_YEAR
     *
     * @return ItemAbstract[] An array of Plex library items.
     */
    ...
    protected function getPolymorphicItem($polymorphicData, $scopedToItem = false)
    {
        if (is_int($polymorphicData)) {
            ...
            if (strpos($polymorphicData, Library::ENDPOINT_METADATA)
                !== false
            ) {
...
//		$class = ucfirst($type);
     ...
     *
     * @uses SectionAbstract::$refreshing
     *
     ...
     *
     * @uses SectionAbstract::$updatedAt
     *
     ...
     *
     * @uses SectionAbstract::$createdAt
     *
