...
namespace Plex\Server\Library\Item\Media\File;

use Plex\Server\Library\Item\Media\File\FileInterface;
    ...
    implements FileInterface
{
     ...
     * Plex HTTP API.
     *
     * @uses Item_Media_File::setId()
     * @uses Item_Media_File::setKey()
     * @uses Item_Media_File::setDuration()
     * @uses Item_Media_File::setFile()
     * @uses Item_Media_File::setSize()
     * @uses Item_Media_File::setContainer()
     *
     * @return void
     */
     ...
     *
     * @uses Item_Media_File::$container
     *
